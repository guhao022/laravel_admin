...
return [
    ...
    'upload' => [
        ...
        'imagePathFormat' => '/upload/image/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'snapscreenPathFormat' => '/upload/image/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'catcherPathFormat' => '/upload/image/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'videoPathFormat' => '/upload/video/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'filePathFormat' => '/upload/file/{yyyy}/{mm}/{dd}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
